...
from .models import Categoria, Receita, Ingrediente, Avaliacao
from .forms import ReceitaForm, IngredienteForm, AvaliacaoForm
...
class ReceitaDetailView(LoginRequiredMixin, FormMixin, DetailView):
    ...
    def form_valid(self, form):
        ...
        form.instance.receita = self.object
        form.save()
        return redirect('receita-detail', pk=self.object.pk)
